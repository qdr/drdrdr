<template>
  <div class="blog">
    <div class="blog__header">
      ...
      <p class="blog__excerpt">{{ $frontmatter.excerpt }}</p>
    </div>
    <img  v-if="$frontmatter.image" class="blog-image" :src="'/images/' + $frontmatter.image" v-bind:alt="$frontmatter.image" >
    <a v-if="$frontmatter.link" :href="$frontmatter.link">{{ $frontmatter.link}}</a>
